...
| **Phase 1** — Core Engine | Core, Engine, Input modules compiling with tests | 🔜 Next |
...
| Phase | Goal | Status |
|-------|------|--------|
| **G1** — First Interaction Loop | R.I.G. state, mining tool, resources, inventory, HUD | 📋 Planned |
