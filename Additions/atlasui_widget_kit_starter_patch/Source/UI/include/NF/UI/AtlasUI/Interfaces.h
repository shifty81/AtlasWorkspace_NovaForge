...
struct ILayoutContext {
    ...
    [[nodiscard]] virtual Vec2 availableSize() const = 0;
    [[nodiscard]] virtual Vec2 measureText(std::string_view text, float fontSize) const = 0;
...
struct IPaintContext {
    ...
    virtual void drawText(const Rect& rect, std::string_view text, FontId font, Color color) = 0;
...
struct IInputContext {
    ...
    [[nodiscard]] virtual Vec2 mousePosition() const = 0;
